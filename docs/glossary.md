...
| Plugin | The native Claude Code plugin (`.claude-plugin/plugin.json`) that carries the runtime — skills, the reader agent, and the Stop hook — served read-only from `~/.claude/plugins/cache/`, external to any consuming repo. |
