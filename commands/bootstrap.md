---
description: Scaffold the Second Brain repo-side files into this repo (docs/second-brain/, CLAUDE.md block, git pre-commit, CI, .second-brain.conf). Create-only; never overwrites or deletes.
allowed-tools: Bash
---
